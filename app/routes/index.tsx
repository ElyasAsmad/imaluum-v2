			...
			<div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-32">
				<div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl">
					...
					<p className="mt-3 text-lg leading-8 text-zinc-800 dark:text-slate-200 text-wrap">
						...
						make our student portal more user-friendly.
					</p>
					<LoginForm />
				</div>
				<div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
					<div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
						<Image
							src="/imaluum.nrmnqdds.com_schedule (1).png"
							alt="App screenshot"
							width={1200}
							height={0}
							priority
							sizes="100%"
							className="rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10 dark:hidden object-contain h-auto block"
						/>
						<Image
							src="/imaluum.nrmnqdds.com_schedule.png"
							alt="App screenshot"
							width={1200}
							height={0}
							priority
							sizes="100%"
							className="rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10 hidden object-contain h-auto dark:block"
						/>
					</div>
				</div>
			</div>
